    ...
    render() {
        return (
            <div className="bg-gray-50 dark:bg-gray-800">
                ...
                <div className="about-me bg-blue-900 px-10 sm:py-10 md:py-20 xl:py-20 rounded-md">
                    <div className="max-w-7xl mx-auto">
                        <div class="pb-20">
                            <h3 className="text-3xl font-extrabold text-center md:text-5xl py-10">Hello again, Nice to meet you.</h3>
                            <p className="text-center text-base leading-10 md:text-2xl md:leading-loose xl:px-48 pb-20">I live in Kirkland, WA, with my beautiful wife and our dachshunds Charlie and Eleven. Eleven was named after Strangers Things, and she likes waffles. I enjoy traveling and exploring new and exciting places, including pizza places (hint: favorite food). </p>
                        </div>
                    </div>
                </div>
                <div className="max-w-7xl mx-auto">
                <div className="bg-indigo-50 mx-4 rounded-3xl py-3 text-gray-900 -mt-20">
