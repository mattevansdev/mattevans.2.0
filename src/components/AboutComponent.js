            ...
            <div className="bg-gray-50 dark:bg-gray-800">
                <div className="jumbotron about-me px-20 sm:py-10 md:py-20 xl:py-28">
                    <div class="container max-w-8xl">
                        ...
                        <p className="text-center leading-loose md:text-base xl:text-lg xl:px-48">I live in Kirkland, WA with my beautiful wife and our dogs Charlie and Eleven. When I’m not
                ...
                <div className="bg-gray-100 container mx-auto skills py-3 text-gray-900 ">
