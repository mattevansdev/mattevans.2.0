    ...
    render() {
        return (
            <div className="min-h-screen">
                <div className="jumbotron about-me px-10 sm:py-10 md:py-20 xl:py-28">
                    <div class="justify-center">
                        <h3 className="text-2xl flex justify-center py-10 xl:py-10 xl:text-4xl">Hello again, Nice to meet you.</h3>
                        <p className="text-center leading-loose xs:text-sm md:text-base xl:text-lg xl:px-48">I live in Kirkland, WA with my beautiful wife and our dogs Charlie and Eleven. When I’m not
                ...
                <div className="skills container">
                    <div className="text-center grid md:col-1 xl:grid-cols-3 divide-x divide-gray-200">
                        <div className="py-10">
                            ...
                            <p className="min-title py-3">Dev Tools:</p>
